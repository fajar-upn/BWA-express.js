/**
 * this is seeder for database
 * dont forget install seeder: npm i seeder
 */
...
seeder.connect('mongodb+srv://saber:gzmqqzow99@cluster0.noasg.mongodb.net/db_staycation?retryWrites=true&w=majority', {
    ...
    seeder.clearModels(['Category', 'Bank', 'Item', 'Member', 'Item', 'Feature', 'Activity', 'Image', 'Booking', 'User'], function () {
    ...
    // start item
    {
        ...
        'documents': [
            ...
            // done
            {
                ...
                categoryId: { _id: mongoose.Types.ObjectId('5e96cbe292b97300fc901111') }
            },
            // done
            {
                // done
                ...
                categoryId: { _id: mongoose.Types.ObjectId('5e96cbe292b97300fc901113') }
            },
        ]
    },
    // end item
